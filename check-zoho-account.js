...
async function main() {
  ...
  console.log('API Response keys:', Object.keys(data.data[0]));
  const tzKeys = Object.keys(data.data[0]).filter(k => k.toLowerCase().includes('time'));
  console.log('Timezone related keys:', tzKeys);
}
