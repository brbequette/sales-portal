...
assert.match(commissions, /hasAuthoritativeLegacyFinancials/)
assert.match(commissions, /hasAuthoritativeInvoiceColumns/)
assert.match(commissions, /classifyCommissionCostQuality/)
...
assert.match(commissions, /const hasStoredCosts = costQuality === COMMISSION_COST_QUALITY\.AUTHORITATIVE/)
...
assert.match(commissionsPage, /invoice\.costQuality === COMMISSION_COST_QUALITY\.BLOCKED/)
