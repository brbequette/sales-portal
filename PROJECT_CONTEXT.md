...
- No invoice, account, payment, or user record was changed. TypeScript validation passes; existing broad lint debt in the legacy Collections files is unchanged. Source deployment is pending.