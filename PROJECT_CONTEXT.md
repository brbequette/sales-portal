...
- Prisma validation, generated-client TypeScript validation, focused lint, five extraction fixture tests, and the full Next.js production build pass. Migration `20260828210000_email_operational_intelligence` and all source changes are undeployed; no mailbox sync, database migration, email send, or production data change was performed.
...
- TypeScript validation passes. No Collections or customer data was changed.