...
- The prior Self Client and its old grants have not yet been revoked. Revocation is intentionally deferred until the replacement code is deployed and production behavior is verified; revocation requires a separate destructive-action confirmation.
