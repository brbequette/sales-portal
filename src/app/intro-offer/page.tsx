...
export default function StandalonePatriotOfferPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-red-600 selection:text-white pb-20 md:pb-0">
      ...
      <div className="bg-blue-950 text-white py-1.5 px-3 border-b border-blue-900">
      ...
      {/* ── HERO SECTION (IMAGES PROMINENTLY ABOVE THE FOLD ON MOBILE) ── */}
      <section className="relative pt-4 sm:pt-8 pb-10 sm:pb-16 px-3.5 sm:px-6 lg:px-10 bg-gradient-to-b from-white via-slate-50 to-blue-50/40 border-b border-slate-200">
        
        <div className="max-w-7xl mx-auto space-y-5">
          
          {/* Top Patriotic Headline Tag */}
          <div className="text-center space-y-2">
            <div className="inline-flex items-center gap-1.5 bg-red-50 border border-red-200 text-red-700 rounded-full px-3.5 py-1 text-[10px] sm:text-xs font-black uppercase tracking-wider shadow-sm">
              <span className="w-2 h-2 rounded-full bg-red-600 animate-ping" />
              <span>OFFICIAL CONTRACTOR INTRODUCTORY BOGO SPECIAL</span>
            </div>

            <h1 className="text-2xl sm:text-5xl lg:text-6xl font-black text-blue-950 tracking-tight uppercase leading-tight max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-6 border border-slate-200 shadow-xl max-w-4xl mx-auto space-y-4">
            ...
            <div className="bg-gradient-to-r from-blue-900 via-blue-950 to-slate-900 text-white p-3.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-lg flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              <div>
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  <span className="text-[9px] font-black uppercase bg-red-600 px-2 py-0.5 rounded">BOGO TOTAL</span>
                  <div className="text-3xl sm:text-4xl font-black text-white leading-none mt-0.5">${pricePerPack.toFixed(2)}</div>
                </div>

                <a
                  href="#order-section"
                  className="bg-gradient-to-r from-red-600 to-amber-500 hover:from-red-500 hover:to-amber-400 text-white px-4 py-3 rounded-xl font-black text-xs uppercase tracking-wider shadow-md transition-all flex items-center gap-1 active:scale-95 shrink-0"
                >
                  <span>CLAIM NOW</span>
          ...
          <div className="max-w-3xl mx-auto text-center space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
              ...
              <div className="bg-white border border-slate-200 p-3 rounded-xl flex items-start gap-2.5 shadow-sm">
                ...
                <div className="text-xs">
                  ...
                  <span className="text-slate-600 font-medium">12mm Laser Welded Segments. Slices 40% faster on hard cured concrete.</span>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 p-3 rounded-xl flex items-start gap-2.5 shadow-sm">
                ...
                <div className="text-xs">
                  ...
                  <span className="text-slate-600 font-medium">14mm Drop Segments. Deep undercut protection for 2x asphalt life.</span>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 justify-center pt-2">
              <a
                href="#order-section"
                className="w-full sm:w-auto bg-gradient-to-r from-red-600 via-red-500 to-blue-900 hover:from-red-500 hover:to-blue-800 text-white font-black text-sm sm:text-base px-8 py-4 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 uppercase tracking-wide active:scale-95"
              >
              ...
              <a
                href="tel:18008482634"
                className="w-full sm:w-auto bg-white hover:bg-slate-100 text-slate-800 border border-slate-300 font-bold text-xs sm:text-sm px-6 py-4 rounded-xl transition-colors flex items-center justify-center gap-2 shadow-sm active:scale-95"
              >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-slate-600 font-bold pt-1">
      ...
      <section className="py-12 sm:py-16 px-3.5 sm:px-6 lg:px-10 bg-white border-t border-slate-200">
      ...
      {/* ── FOOTER ── */}
      <footer className="py-8 px-4 border-t border-slate-200 bg-slate-100 text-center text-xs text-slate-600 space-y-2">
