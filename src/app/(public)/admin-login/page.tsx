      ...
      <div className="w-full max-w-md rounded-3xl border border-amber-500/40 bg-neutral-900/90 p-8 shadow-[0_0_60px_rgba(245,158,11,0.15)] backdrop-blur-2xl relative z-10">
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-20 items-center justify-center">
            <Image src="/images/brand/logo-system/titan-wordmark-light.png" alt="Titan Diamond USA Admin" width={320} height={72} priority className="h-14 max-w-full w-auto object-contain filter drop-shadow-[0_0_15px_rgba(245,158,11,0.3)]" />
          </div>
        ...
        <div className="mt-7 flex justify-center gap-4 border-t border-white/10 pt-5 text-xs text-neutral-500">
          <Link href="/employee-login" className="hover:text-emerald-400">Employee login</Link><span>•</span><Link href="/master-admin-login" className="hover:text-red-300">Master Administrator</Link><span>•</span><Link href="/login" className="hover:text-amber-400">Customer login</Link>
        </div>
      </div>
    </main>
  );
