        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {displayedConflicts.map((doc) => {
            ...
            return (
              <div 
                key={doc.id} 
                className={`glass-panel border border-white/10 rounded-2xl p-5 flex flex-col transition-all duration-300 ${isResolving ? 'opacity-50 scale-[0.98] pointer-events-none' : ''}`}
              >
