      ...
      <main className="flex-1 px-4 sm:px-6 py-4 space-y-5 overflow-y-auto safe-bottom max-w-4xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white tracking-tight">Invoice Cost Management</h1>
              <p className="text-xs text-neutral-500">Recalculate and fix historical invoice numbers in bulk</p>
            </div>
          </div>
        </div>
