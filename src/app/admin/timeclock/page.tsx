      ...
      <div className="page-header">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center">
            <FiClock className="text-emerald-500" size={17} />
          </div>
          <div>
            <h1 className="page-title">Timeclock Admin</h1>
            <p className="page-subtitle">Review clock entries, adjust times, manage geofence locations.</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
