...
<html>
<head>
  <title>${title} â€” Titan Diamond Training</title>
  <style>
...
<body>
  <div style="text-align:center;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #0a6;">
    <h1 style="font-size:28px;font-weight:900;color:#111;margin:0;">Titan Diamond â€” Sales Hub</h1>
  ...
  <div style="margin-top:32px;padding-top:16px;border-top:1px solid #e5e5e5;text-align:center;font-size:11px;color:#999;">
    Â© ${new Date().getFullYear()} Titan Diamond â€” Confidential Training Material
  </div>
</body>
</html>`
    ...
    <div className="p-4 lg:p-8 flex flex-col h-[calc(100dvh-7rem)] lg:h-screen max-w-7xl mx-auto">
      <div className="mb-6 shrink-0 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-400 mt-1">Learn how to use every part of the Titan Hub â€” sales, communication, collections, payroll, and admin.</p>
        </div>
        <button
