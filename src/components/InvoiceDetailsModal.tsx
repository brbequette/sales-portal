...
import { useInvoiceDetailsData, type InvoiceDetailsModalProps } from "./useInvoiceDetailsData"
                        ...
                        <tbody className="divide-y divide-white/5">
                          {displayData.line_items.map((item: any, i: number) => (
                            <tr key={item.line_item_id || i} className="hover:bg-white/[0.02] transition-colors">
                              ...
                              <td className="px-3 py-2 text-neutral-400 font-mono hidden sm:table-cell">{item.sku || (typeof item.item_code === 'string' ? item.item_code : '') || '--'}</td>
