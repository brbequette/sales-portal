                    ...
                    <div className="flex items-center gap-2 mt-1" onClick={e => e.stopPropagation()}>
                      <button 
                        onClick={(e) => {
                          e.preventDefault()
                          e.stopPropagation()
                          window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: c.phone || c.mobilePhone, accountId, tab: 'dialer' } }))
                        }}
                      ...
                      <button 
                        onClick={(e) => {
                          e.preventDefault()
                          e.stopPropagation()
                          window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: c.phone || c.mobilePhone, accountId, tab: 'sms' } }))
                        }}
                      ...
                      <span className="text-neutral-500 font-mono text-[9px] ml-1">
                        (<button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: c.phone || c.mobilePhone, accountId, tab: 'dialer' } })) }} className="text-blue-400 hover:underline">
                          {c.phone || c.mobilePhone}
                        </button>)
                      </span>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-neutral-950/40 p-4 rounded-xl border border-neutral-800/80">
                  ...
                  <div className="space-y-0.5">
                    ...
                    {selectedContact.phone ? (
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: selectedContact.phone, accountId, tab: 'dialer' } }))}
                        ...
                        <button
                          onClick={() => window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: selectedContact.phone, accountId, tab: 'sms' } }))}
                  ...
                  <div className="space-y-0.5 sm:col-span-2">
                    ...
                    {selectedContact.mobilePhone ? (
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: selectedContact.mobilePhone, accountId, tab: 'dialer' } }))}
                          className="text-xs text-blue-400 hover:underline font-mono"
                        >
                          {selectedContact.mobilePhone}
                        </button>
                        ...
                        <button
                          onClick={() => window.dispatchEvent(new CustomEvent('open-softphone', { detail: { number: selectedContact.mobilePhone, accountId, tab: 'sms' } }))}
                          className="text-[10px] text-emerald-455 hover:underline flex items-center gap-0.5 cursor-pointer font-bold"
                        >
                          Text
                        </button>
