...
export function AccountHistory({
  ...
  const logs = notes.map((note) => ({
    id: note.id,
    date: note.createdAt ? new Date(note.createdAt).toLocaleDateString(undefined, { timeZone: 'UTC' }) : "â€”",
            ...
            {invoices.length === 0 ? (
              ...
              <div className="space-y-3">
                {invoicesPagination.paginatedItems.map(inv => {
                  ...
                  const formattedDate = inv.issueDate ? new Date(inv.issueDate).toLocaleDateString(undefined, { timeZone: 'UTC' }) : "â€”"
            ...
            {salesOrders.length === 0 ? (
              ...
              <div className="space-y-3">
                {ordersPagination.paginatedItems.map(so => {
                  ...
                  const formattedDate = so.orderDate ? new Date(so.orderDate).toLocaleDateString(undefined, { timeZone: 'UTC' }) : "â€”"
            ...
            {quotes.length === 0 ? (
              ...
              <div className="space-y-3">
                {quotesPagination.paginatedItems.map(quote => {
                  ...
                  const formattedDate = quote.createdAt ? new Date(quote.createdAt).toLocaleDateString(undefined, { timeZone: 'UTC' }) : "â€”"
