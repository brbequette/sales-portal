...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // ── Auth / layout bypass ──────────────────────────────────────────────────
  const isPublicPage = pathname === "/" || pathname.startsWith("/shop") || pathname === "/about" || pathname === "/contact" || pathname.startsWith("/resources") || pathname.startsWith("/blade-finder") || pathname.startsWith("/applications") || pathname.startsWith("/signature-series") || pathname === "/privacy" || pathname === "/terms"
