...
export function SalesCallCampaignModal({ accounts, onClose, onRefresh }: SalesCallCampaignModalProps) {
  ...
  const {
    ...
    factFinding, setFactFinding, callType, setCallType, aiPrompt, setAiPrompt,
    aiType, setAiType, aiChannel, setAiChannel, aiResult, setAiResult,
    ...
    getBladeRecommendation, handleNext, handleGenerateAi, handleLogAndNext
  } = data
