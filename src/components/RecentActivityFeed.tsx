...
export function RecentActivityFeed() {
  ...
  useEffect(() => {
    ...
    setActivities([
      { id: "1", title: "New Lead Created", description: "John Doe from Acme Corp", timestamp: new Date(Date.now() - 1000 * 60 * 5), type: "account" },
      { id: "2", title: "Invoice Paid", description: "INV-10492 ($450.00) paid by XYZ Inc", timestamp: new Date(Date.now() - 1000 * 60 * 22), type: "invoice" },
      { id: "3", title: "Task Completed", description: "Follow up with Sarah", timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2), type: "task" },
      { id: "4", title: "Zoho Sync Complete", description: "48 accounts synchronized", timestamp: new Date(Date.now() - 1000 * 60 * 60 * 4), type: "system" },
    ])
  }, [])
