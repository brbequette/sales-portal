...
- **Order Builder**: Search any product from catalog with live search dropdown, or quick-add promo blades with one tap. Each line item has paid qty, free qty (green), editable unit price, and auto-calculated line total. "Preview Sales Order" button opens a mock sales order that separates paid items and free/gift items into distinct line item sections with customer info and order totals. Order data is saved with the call log.
