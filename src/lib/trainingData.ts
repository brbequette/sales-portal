...
- **Order Builder**: Add blade products with one tap. Each line item has paid qty, free qty (green), editable unit price, and auto-calculated line total. Promo pricing auto-fills. Summary shows paid blades, free blades, total shipping, order total, and per-blade cost. Order data is saved with the call log.
